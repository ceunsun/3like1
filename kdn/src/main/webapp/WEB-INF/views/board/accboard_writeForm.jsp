				...
				<div class="tm-what-we-do-right">
					<div class="dreamcrub">
						<ul class="breadcrumbs">
							<li class="home"><a href="home.do" title="Go to Home Page">
						...
						<form action="accboard_write.do" method="post">
							<div class="form-group">
								<div class='input-group date' id='datetimepicker2'>
									<input type='text' class="form-control" name="enddate" placeholder="-- 반납일 --" /> 
									<span class="input-group-addon"> <span class="fa fa-calendar"></span></span>
								</div>
							</div>							
							<div class="form-group">
								<input type="text" name="memberno" id="memberno"
									class="form-control" value="${memberno}" />
							</div>
							<div class="form-group">
							...
							<div class="boardbtn">
								<input type="submit" value="작성 완료"> <a
									href="accboard.do?pageNo=${pageNo}"><input type="button"
									value="취소"></a>
							</div>
						</form>
					</div>
